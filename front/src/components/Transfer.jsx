...
export function Transfer() {
  ...
  return (
    ...
    >
      <div><Toaster/></div>
      <div className='w-50 border border-2 border-primary rounded-3 p-3 shadow' style={{background: "#090730"}} >
        ...
        <div className='text-light mt-3'>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="mx-1 bi bi-router" viewBox="0 0 16 16">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="mx-1 bi bi-fuel-pump" viewBox="0 0 16 16">
...
function SpinnerButton({children}){
  return <button className="btn btn-primary fs-5" type="button" disabled>
...
function showSuccessToast(transactionHash){
  toast((t) => (
    <span>Validado <Link to={`/explorer/tx/${transactionHash}`}>Ver en explorer</Link>
      <button className='btn btn-dark btn-sm ms-2' onClick={() => toast.dismiss(t.id)}>x</button>
    </span>
  ), {
    duration: 5000,
    icon: '✅', //❌
